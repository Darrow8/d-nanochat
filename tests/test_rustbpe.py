# Copied from nanochat because testing harness
...
def get_cache_dir():
    """Get cache directory for test data."""
    import os
    if os.environ.get("NANOCHAT_BASE_DIR"):
        cache_dir = os.environ.get("NANOCHAT_BASE_DIR")
    else:
        home_dir = os.path.expanduser("~")
        cache_dir = os.path.join(home_dir, ".cache", "nanochat")
...
@pytest.mark.skip(reason="Requires nanochat.tokenizer module which is not available in d-nanochat")
